...
:: Bake!
:: WORK
::C:\wamp\bin\php\php5.6.19\php.exe tools/bake.php %IMPACT_LIBRARY% %GAME% %OUTPUT_FILE%

:: If you dont have the php.exe in your PATH uncomment the
:: following line and point it to your php.exe

:: HOME
C:\wamp\bin\php\php5.5.12\php.exe tools/bake.php %IMPACT_LIBRARY% %GAME% %OUTPUT_FILE%
